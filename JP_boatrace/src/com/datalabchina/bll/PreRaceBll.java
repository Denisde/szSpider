...
//	public boolean isUseTraead = true;
	...
	public void run(){
		...
		try {
			...
			logger.info(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> start to exec pr_Consolidate_PreRace_ByOneDay ,'"+ Controller.sStartDate+"'");
			oCommonDB.execStoredProcedures("pr_Consolidate_PreRace_ByOneDay", "'"+ Controller.sStartDate+"','"+Controller.sEndDate+"'");
		}
	}
...
//			DateFormat yyyyMMddHHmm = new SimpleDateFormat("yyyyMMddHH:mm");
			...
			//<a href="/owpc/pc/race/raceresult?rno=1&jcd=23&hd=20170726">
...
//		 p.parsePreByRaceID("2017071701003");
