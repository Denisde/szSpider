...
public class ParseCPJS14 {
	private static Logger logger = Logger.getLogger(ParseCPJS14.class.getName());
...
//										String sSql ="";
										...
										logger.info("pr_PmuInfoCentreKafka_XML_PlayedHorses_WinBetAndStakes_InsertData  " + sSql);
										oCommonDB.execStoredProcedures("pr_PmuInfoCentreKafka_XML_PlayedHorses_WinBetAndStakes_InsertData", sSql.toString());
										 sSql=null;
							}
						}
					}
	...
	public static void main(String[] args) {
		...
		String filePath ="D:\\Denis\\PMU XPRO APP\\XML\\14_CHX_PLUS_JOUES_SG";
		new ParseCPJS14().run(filePath);
	}
}
