...
public class Parse624 {
						...
						while(citations_epc.find()){
							...
							while(partant.find()){
								...
								while(citation.find()){
									...
									logger.info("pr_PmuInfoCentreKafka_XML_CITATIONS_TR_InsertData  " + sSql);
									oCommonDB.execStoredProcedures("pr_PmuInfoCentreKafka_XML_CITATIONS_TR_InsertData", sSql.toString());
									sSql=null;
	...
	public static void main(String[] args) {
		...
		String filePath ="D:\\Denis\\PMU XPRO APP\\20180801\\624";
		new Parse624().run(filePath);
	}
}
