...
public class ParseGDDP105 {
	private static Logger logger = Logger.getLogger(ParseGDDP105.class.getName());
				...
				while(reunionMatcher.find()){
					...
					while(courseMatcher.find())
					{
						...
						while(partantsMatcher.find()){
							...
							String journaliste = oCommonMethod.getValueByPatter(onepartant, "<journaliste>(.*?)</journaliste>");
...
//							String sSql ="";
							...
							logger.info("pr_PmuInfoCentreKafka_XML_Geny_LiveFromTheTrack_InsertData  " + sSql);
							oCommonDB.execStoredProcedures("pr_PmuInfoCentreKafka_XML_Geny_LiveFromTheTrack_InsertData", sSql.toString());
							 sSql=null;
						}
					}
				}
	...
	public static void main(String[] args) {
		...
		String filePath ="D:\\Denis\\PMU XPRO APP\\XML\\105_GNY_DIRECT_DES_PISTES";
		new ParseGDDP105().run(filePath);
	}
}
