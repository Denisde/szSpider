...
public class Parse643 {
						...
						while(citations_epc.find()){
							...
							while(partant.find()){
								...
								while(citation.find()){
									...
									String place_arr = oCommonMethod.getValueByPatter(onecitation, "<place_arr>(.*?)</place_arr>");
									...
									sSql=sSql.append(place_arr==null?"NULL,":"N'"+place_arr+"',");
									...
									logger.info("pr_PmuInfoCentreKafka_XML_CITATIONS_PICK_5_InsertData  " + sSql);
									oCommonDB.execStoredProcedures("pr_PmuInfoCentreKafka_XML_CITATIONS_PICK_5_InsertData", sSql.toString());
									sSql=null;
	...
	public static void main(String[] args) {
		...
		String filePath ="D:\\Denis\\PMU XPRO APP\\20180801\\643";
		new Parse643().run(filePath);
	}
}
