...
public class ParseTQ110 {
	private static Logger logger = Logger.getLogger(ParseTQ110.class.getName());
			...
			while(JoursMatcher.find())
			{
				...
				while(reunionMatcher.find())
				{
					...
					while(courseMatcher.find())
					{
							...
							String commentaire = oCommonMethod.getValueByPatter(onecourse, "<commentaire.*?>(.*?)</commentaire >");
...
//								String sSql ="";
								...
								logger.info("pr_PmuInfoCentreKafka_XML_Geny_TipsQuinte_InsertData  " + sSql);
								oCommonDB.execStoredProcedures("pr_PmuInfoCentreKafka_XML_Geny_TipsQuinte_InsertData", sSql.toString());
								 sSql=null;
							}
					}
				}
	...
	public static void main(String[] args) 
	{
		...
		String filePath ="D:\\Denis\\PMU XPRO APP\\XML\\110_GNY_PRONO_Q5";
		new ParseTQ110().run(filePath);
	}
}
