						...
						while(citations_epc.find()){
							...
							while(partant.find()){
								...
								while(citation.find()){
									...
									logger.info("pr_PmuInfoCentreKafka_XML_CITATIONS_2SUR4_InsertData  " + sSql);
									oCommonDB.execStoredProcedures("pr_PmuInfoCentreKafka_XML_CITATIONS_2SUR4_InsertData", sSql.toString());
									sSql=null;
