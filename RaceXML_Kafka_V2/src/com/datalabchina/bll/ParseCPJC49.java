...
public class ParseCPJC49 {
	private static Logger logger = Logger.getLogger(ParseCPJC49.class.getName());
...
//								String sSql ="";
								...
								logger.info("pr_PmuInfoCentreKafka_XML_PlayedHorses_Exacta_InsertData  " + sSql);
								oCommonDB.execStoredProcedures("pr_PmuInfoCentreKafka_XML_PlayedHorses_Exacta_InsertData", sSql.toString());
								sSql=null;
							}
						}
					}
	...
	public static void main(String[] args) {
		...
		String filePath ="D:\\Denis\\PMU XPRO APP\\XML\\49_COMB_PLUS_JOUES_CO";
		new ParseCPJC49().run(filePath);
	}
}
