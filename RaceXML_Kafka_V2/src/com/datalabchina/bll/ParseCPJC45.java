...
public class ParseCPJC45 {
	private static Logger logger = Logger.getLogger(ParseCPJC45.class.getName());
	...
	//										 String sSql ="";
								...
								logger.info("pr_PmuInfoCentreKafka_XML_PlayedHorses_Quinella_InsertData  " + sSql);
								oCommonDB.execStoredProcedures("pr_PmuInfoCentreKafka_XML_PlayedHorses_Quinella_InsertData", sSql.toString());
								sSql=null;
							}
						}
					}
	...
	public static void main(String[] args) {
		...
		String filePath ="D:\\Denis\\PMU XPRO APP\\XML\\45_COMB_PLUS_JOUES_CG";
		new ParseCPJC45().run(filePath);
	}
}
