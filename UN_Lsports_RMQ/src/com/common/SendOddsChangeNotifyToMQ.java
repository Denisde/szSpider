...
//
//public class SendOddsChangeNotifyToMQ extends Thread {
//	private static Logger logger = Logger.getLogger(SendOddsChangeNotifyToMQ.class);
...
//				new Thread(new SendOddsChangeNotifyToMQ(), "SendOddsChangeNotifyToMQ_Thread").start();
//			}
//			
//		}		
//	}
