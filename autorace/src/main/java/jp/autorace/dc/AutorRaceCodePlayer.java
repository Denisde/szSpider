 ...
 */
public class AutorRaceCodePlayer implements java.io.Serializable {
	...
	public AutorRaceCodePlayer() {
	}

	public AutorRaceCodePlayer(int playerId) {
		this.playerId = playerId;
	}

	public AutorRaceCodePlayer(int playerId, String playerName, String playerNameEn,
