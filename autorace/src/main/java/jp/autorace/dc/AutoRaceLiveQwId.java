...
/**
 * AutoRaceLiveQwId generated by hbm2java
 */
public class AutoRaceLiveQwId implements java.io.Serializable {

	private long raceid;
	private Date timeStamp;

	public AutoRaceLiveQwId() {
	}

	public AutoRaceLiveQwId(long raceid, Date timeStamp) {
		this.raceid = raceid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AutoRaceLiveQwId))
			return false;
		AutoRaceLiveQwId castOther = (AutoRaceLiveQwId) other;
